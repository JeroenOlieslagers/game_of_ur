...
"""
function value_iteration(V::Dict{UInt32, Float64}, no_leafs::Set{UInt32}, θ::Float64, bs::Vector{UInt32}, bbs::Vector{UInt32}, Ps::Vector{Float64}; max_iter=100)::Nothing
    start_time = now()
...
"""
function get_value_map(visited::Dict{Tuple{Int64, Int64}, Set{UInt32}}, leafs::Set{UInt32}, θ::Float64; max_iter=100, N=7)::Dict{UInt32, Float64}
    start_time = now()
    ...
    value_iteration(V, all_states, θ, bs, bbs, Ps; max_iter=max_iter)
